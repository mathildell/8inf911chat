...
//-----------------------------------------------
    ...
    if (socket !== undefined) {
        ...
        socket.on('output-all', function (data, storage_data) {
            ...
            if(parseInt($('#chatroom').val()) !== dataChat(data.chatroom)){
                $('#chatroom').val(dataChat(data.chatroom));
            }
...
//                        + data.message +
        ...
        $('#submit').click(function (e) {
            ...
            console.log('name: ' + name + ' avatar: ' + $avatar + ' storageCheck: ' + storageCheck + ' chatroom: ' + parseInt($chatroom.val()));
            ...
            socket.emit('userinput',
                {
                    ...
                    date: date,
                    chatroom: parseInt($chatroom.val()),
                    avatar: $avatar.html()
